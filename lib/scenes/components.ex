defmodule Golux.Scene.Components do
  @moduledoc """
  Sample scene.
  """

  use Scenic.Scene
  alias Golux.Component.Nav
  alias Scenic.Graph
  import Scenic.Primitives
  import Scenic.Components

  alias Golux.Component.Nav
  alias Golux.Component.Notes
               ...
               fn g ->
                 ...
                 |> group(
                   fn g ->
                     ...
                     |> button("Secondary", id: :btn_secondary, width: 100, t: {270, 40}, theme: :secondary)
                   end,
                   translate: {0, 10}
                 )
                 ...
                 |> text_field("", id: :password, width: 240, hint: "Password", type: :password, t: {200, 200})
                 |> dropdown(
                   {
