defmodule Golux.Component.Nav do
  ...
  def init(current_scene, opts) do
    ...
    graph =
      ...
      |> dropdown(
        {[
           # {"Sensor", Golux.Scene.Sensor},
           {"Primitives", Golux.Scene.Primitives},
           {"Components", Golux.Scene.Components},
           {"Transforms", Golux.Scene.Transforms},
           {"Game of life", Golux.Scene.GameOfLife}
         ], current_scene},
        id: :nav,
        translate: {70, 15}
      )
